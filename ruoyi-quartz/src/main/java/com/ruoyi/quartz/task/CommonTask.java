 ...
 */
@Component("common")
public class CommonTask extends AbstractEmailTask implements SchedulingConfigurer {
    ...
    // 方法1：今日活动提醒
    public void notifyTodayEvent(String subject, String time) throws MessagingException {
        // 提取所有成员的 qq 字段
    ...
    // 方法2：活动上线提醒
    public void notifyEventActivation(String subject, String time) throws MessagingException {
        // 提取所有成员的 qq 字段
        Member member = new Member();
        member.setState(MemberState.IN_ORGANIZATION.getCode());
